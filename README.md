...
Ос собирается на ubuntu, но запусть образ на виртуалке или реальном железе не получается. 
Выдает:
...
Скрипт настройки пока работает неверно, после его выполнение необходимо произвести ряд изменений описанных
